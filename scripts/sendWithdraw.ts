...
export async function run() {
  ...
  // (the walletSender must be equal to owner (original creator of a contract))
  const TO_WITHDRAW = toNano("0.1")
  await deployedContract.sendWithdraw(walletSender, toNano("0.005"), TO_WITHDRAW);
